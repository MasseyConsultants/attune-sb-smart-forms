...
| SB-016 | P1       | Platform admin console (orgs, users, subscriptions, usage, lifecycle/legal-hold actions, support impersonation) | Owner request 2026-07-13      | Propose S9 or S10         | PLATFORM_ADMIN role + lifecycle endpoints exist; needs admin API + UI surface |
