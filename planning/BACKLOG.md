...
| SB-020 | P1       | Form trigger node: start node shows bound form's fields; field-token picker in node config (vs typing {{...}})  | Owner testing 2026-07-14      | Propose S10               | Data already flows (formData.* interpolation); this is discoverability UX like Zapier/Power Automate |
